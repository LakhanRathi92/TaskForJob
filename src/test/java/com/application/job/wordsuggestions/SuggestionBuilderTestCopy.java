...
public class SuggestionBuilderTestCopy {
    ...
    public void algoTest(){
        final String[] TOKENS  =  {"The", "beautiful", "girl", "from", "the", "farmers", "market", ".", "I", "like", "chewing", "gum", "." };
        final String[] STOP_WORDS = {"is", "can", "the"};
        Set<String> stopWords = new HashSet<>(Arrays.asList(STOP_WORDS));
        Set<Suggestion> out = buildSuggestionsFromTokenFromString(Arrays.asList(TOKENS).iterator(), stopWords);
        Stream.of(out).forEach(System.out::println);
    }
}